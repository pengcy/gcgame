...
public class CMonsterMrBean extends CBaseEntity
{
	Random generator; 
	//constants
	final int DIR_N  = 0,
	...
	public CMonsterMrBean(float pX, float pY, float pTileWidth, float pTileHeight,
	...
	public CMonsterMrBean(final float pX, final float pY, final TiledTextureRegion pTiledTextureRegion, int maxHP) 
	{
